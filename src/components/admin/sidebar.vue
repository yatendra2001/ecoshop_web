    ...
    <div class="flex flex-col w-48 h-screen text-gray-100 bg-gray-700 border-r">
        <div class="flex-grow mx-auto mt-2">
            <ul class="space-y-4">
                <router-link to="/admin/">
                    <li class="flex items-center p-4 text-lg cursor-pointer hover:bg-gray-100 hover:text-yellow-500" :class="[
        ...
        <div class="mx-auto">
            <ul>
                ...
                <router-link to="/">
                    <li class="flex items-center p-4 text-lg cursor-pointer hover:bg-gray-100 hover:text-yellow-500">
